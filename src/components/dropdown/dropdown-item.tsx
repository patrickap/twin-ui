...
const DropdownItem = ({ icon, onSelect, children }: DropdownItemProps) => {
	return (
		<dropdown.Item
			onSelect={onSelect}
			className="group flex w-full cursor-pointer items-center gap-2 rounded-lg bg-white p-2 text-base text-slate-700 focus:outline-none data-[highlighted]:bg-primary-500 data-[highlighted]:text-white sm:text-sm"
		>
			{icon ? (
